...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #294469, #3688d1); color: white; padding: 20px; border-radius: 8px 8px 0 0; }
        .content { background: #f8fafc; padding: 20px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 8px 8px; }
        .field { margin-bottom: 12px; padding-bottom: 12px; border-bottom: 1px solid #e2e8f0; }
        .field-label { font-weight: 600; color: #475569; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; }
        .field-value { margin-top: 4px; color: #1e293b; }
        .meta { margin-top: 16px; padding-top: 16px; border-top: 2px solid #e2e8f0; font-size: 13px; color: #64748b; }
...
<div class="content">
    ...
    <div class="meta">
        ...
        @endif
        <p><strong>Дата:</strong> {{ $submission->createdAt?->format('d.m.Y H:i') ?? '—' }}</p>
