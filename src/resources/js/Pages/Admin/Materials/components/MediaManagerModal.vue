<!-- resources/js/Pages/Admin/Materials/components/MediaManagerModal.vue -->
<template>
        ...
        <div class="media-manager-modal">
            ...
            <div class="media-manager-footer">
                <div class="footer-info">
                    <span class="text-sm text-gray-600" v-if="!selectedFile">Выберите файл для вставки ссылки</span>
...
/* Принудительное растягивание контента на всю высоту */
