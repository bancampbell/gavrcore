<template>
    <div>
        ...
        >
            <span
                v-if="hasChildren"
                class="inline-flex items-center justify-center w-3.5 h-3.5 mr-1.5 border rounded hover:bg-gray-200"
                :class="isOpen ? 'bg-gray-100' : ''"
                style="border-color: #333;"
            >
                <svg v-if="!isOpen" class="w-2.5 h-2.5" fill="none" stroke="#333" stroke-width="3" viewBox="0 0 24 24">
            ...
            <span class="mr-2 inline-flex items-center justify-center">
                <svg v-if="!isOpen" class="w-5 h-5" fill="#D2B073" stroke="#D2B073" stroke-width="1.5" viewBox="0 0 24 24">
        ...
        <div v-if="hasChildren && isOpen" class="ml-6">
            <FolderTree
